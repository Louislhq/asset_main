define(['core/basics'], function(basics){
	...
	var Pop = function(o){
		var g      = this,
			...
			*/
			_core  = {
					...
					if( url ){
						...
						$.ajax({
							...
							success : function(data){
                                if( basics.base.isFunction(ajaxSuccess) ){
                                    ajaxSuccess(data);
                                }
					...
					if( btns ){
						...
						btnMain
							...
							.on('click', 'a', function(){
								...
								basics.base.isFunction(item.onclick) && item.onclick.apply(this, [id, i, item, that]);
								isClose && g.close(id);
							});
				...
				*/
				loadFn: function(){
					if( basics.base.isFunction(p.onloadFn) ){
		...
		*/
		g.close = function(id){
			...
			/*关闭时要触发的事件*/
			if( basics.base.isFunction(closeFn) ){
		...
		/**
		* 修改标题
		* @method basics.ui.pop.modifyTitle
		...
		*/
		...
		/**
		* 修改按钮
		* @method basics.ui.pop.modifyBtns 
		...
		*/
		...
		/**
		* 修改窗体大小
		* @method basics.ui.pop.modifyWrap 
		* @param {Number} width 
		* @param {Number} height
		*/
